...
/**
 * Servlet implementation class AdminIncheonPicUpServlet
 */
@WebServlet("/AdminIncheonPicUp")
public class AdminIncheonPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminIncheonPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "incheon" + "."
		...
		int result = new AdminService().incheonUpdate(admin);

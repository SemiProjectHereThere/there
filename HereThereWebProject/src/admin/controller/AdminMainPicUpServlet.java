...
/**
 * Servlet implementation class adminMainPicUpServlet
 */
@WebServlet("/adminMainPicUp")
public class AdminMainPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMainPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new AdminService().mainUpdate(admin);

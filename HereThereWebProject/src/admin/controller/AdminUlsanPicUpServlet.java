...
/**
 * Servlet implementation class AdminUlsanPicUpServlet
 */
@WebServlet("/AdminUlsanPicUp")
public class AdminUlsanPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminUlsanPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "ulsan" + "."
		...
		int result = new AdminService().ulsanUpdate(admin);

...
/**
 * Servlet implementation class AdminDaejeonPicUpServlet
 */
@WebServlet("/AdminDaejeonPicUp")
public class AdminDaejeonPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDaejeonPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "daejeon" + "."
		...
		int result = new AdminService().daejeonUpdate(admin);

...
/**
 * Servlet implementation class AdminSeoulPicUpServlet
 */
@WebServlet("/AdminSeoulPicUp")
public class AdminSeoulPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSeoulPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "seoul" + "."
		...
		int result = new AdminService().seoulUpdate(admin);

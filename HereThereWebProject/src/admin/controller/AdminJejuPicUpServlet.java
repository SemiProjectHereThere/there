...
/**
 * Servlet implementation class AdminJejuPicUpServlet
 */
@WebServlet("/AdminJejuPicUp")
public class AdminJejuPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminJejuPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "jeju" + "."
		...
		int result = new AdminService().jejuUpdate(admin);

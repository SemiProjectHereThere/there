...
/**
 * Servlet implementation class AdminMain2PicUpServlet
 */
@WebServlet("/AdminMain2PicUp")
public class AdminMain2PicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMain2PicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "main2" + "."
		...
		int result = new AdminService().mainSecUpdate(admin);

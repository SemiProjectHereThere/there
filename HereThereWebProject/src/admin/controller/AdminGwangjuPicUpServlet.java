...
/**
 * Servlet implementation class AdminGwangjuPicUpServlet
 */
@WebServlet("/AdminGwangjuPicUp")
public class AdminGwangjuPicUpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminGwangjuPicUpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//바꿀 이름 만들기
		renameFileName = /*formatFileName.format(new java.sql.Date(currentTime))*/memberId + "gwangju" + "."
		...
		int result = new AdminService().gwangjuUpdate(admin);

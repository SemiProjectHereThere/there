    ...
    function html5Upload() {	
    	...
    	sUploadURL= "/HereThere/file_uploader_html5.jsp"; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : "/HereThere/file_uploder.jsp",   //변경 URL입니다.
 			sCallback : "/HereThere/smarteditor/photo_uploader/callback.html",  //업로드 이후에 iframe이 redirect될 콜백페이지의 주소
